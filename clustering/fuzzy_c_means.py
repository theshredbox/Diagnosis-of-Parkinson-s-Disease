...
if __name__ == '__main__':
    ...
    df = ParkinsonDataset.load_dataset(path= r"C:\Users\Aryan\PycharmProjects\parkinson-progression-prediction-with-speech-tests-master\dataset\parkinsons_updrs.data",
                                       return_gender=False)
    ...
    path = r"C:\Users\Aryan\PycharmProjects\parkinson-progression-prediction-with-speech-tests-master\results\clustering\fuzzy_c_means"
